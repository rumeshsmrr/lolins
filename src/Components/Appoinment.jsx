...
// 							className="px-6 py-2 text-lg transition border rounded-md cursor-none text-secondaryText border-secondaryText hover:bg-secondary-200 hover:text-primary"
// 						>
// 							Cancel
// 						</button>
// 						<button
...
// 							className="px-6 py-2 text-lg transition rounded-md bg-secondaryText cursor-none text-primary hover:bg-primaryText hover:text-primary"
// 						>
// 							Book
// 						</button>
// 					</div>
                    ...
                    <div className="flex justify-center gap-6 mt-6">
                        ...
                        <motion.button
                            ...
                            className={`relative inline-block px-6 py-2 overflow-hidden text-lg transition-all duration-300 ease-out bg-white border rounded-md border-secondaryText text-secondaryText ${
                                inputValue && !errorMessage && inputValue1 && !errorMessage1 && inputValue2 && !errorMessage2 && selectedValue && inputValue3 && inputValue4
